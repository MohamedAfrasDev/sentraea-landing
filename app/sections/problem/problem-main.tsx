...
const ProblemMain = () => {
  return (
    <div className="flex flex-col relative pb-10">
      ...
      <Problem />
      <div className="mt-10 text-center relative px-10">
        ...
        <p className="text-xl text-muted-foreground md:text-3xl mt-10">
          You don't need another dashboard.{" "}
        </p>
        <p className="text-xl text-muted-foreground md:text-3xl mt-1">
